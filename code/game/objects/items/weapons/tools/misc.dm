...
/obj/item/weapon/tool/medmultitool/medimplant
	...
	tool_qualities = list()
	toggleable = TRUE
	switched_on_qualities = list((QUALITY_CLAMPING = 30, QUALITY_RETRACTING = 30, QUALITY_BONE_SETTING = 30, QUALITY_CAUTERIZING = 30, QUALITY_SAWING = 15, QUALITY_CUTTING = 30, QUALITY_WIRE_CUTTING = 15)
	switched_off_qualities = list()
	use_power_cost = 1.2
...
/obj/item/weapon/tool/engimplant
	...
	tool_qualities = list()
	toggleable = TRUE
	switched_on_qualities = list(QUALITY_SCREW_DRIVING = 35, QUALITY_BOLT_TURNING = 35, QUALITY_DRILLING = 15, QUALITY_WELDING = 30, QUALITY_CAUTERIZING = 10, QUALITY_PRYING = 25, QUALITY_DIGGING = 20, QUALITY_PULSING = 30, QUALITY_WIRE_CUTTING = 30)
	switched_off_qualities = list()
