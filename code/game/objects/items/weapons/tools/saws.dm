...
/obj/item/weapon/tool/saw/chain //tier 4, focusing on damage, fuel variant
	...
	tool_qualities = list(QUALITY_ SAWING = 10, QUALITY_CUTTING = 5, QUALITY_WIRE_CUTTING = 1) //not the best choice to cut wires
	toggleable = TRUE
	switched_on_qualities = list(QUALITY_SAWING = 60, QUALITY_CUTTING = 50, QUALITY_WIRE_CUTTING = 20)
	switched_off_qualities = list(QUALITY_ SAWING = 10, QUALITY_CUTTING = 5, QUALITY_WIRE_CUTTING = 1)
